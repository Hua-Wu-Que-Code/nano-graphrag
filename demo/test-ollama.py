...
from examples.using_ollama_as_llm_and_embedding import ollama_embedding, ollama_model_if_cache  # 导入 Ollama embedding 和 LLM

# 初始化 GraphRAG，指定本地 embedding 和 deepseek LLM
rag = GraphRAG(
    working_dir="./dickens-1",
